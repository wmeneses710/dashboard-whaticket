...
\begin{enumerate}
  ...
  \item \textbf{Si no se puede seccionar, todo le llega a todos.} Es el origen de los
        problemas de visibilidad (sección \ref{sec:visibilidad}) y de la encuesta que se
        envía a los agentes (sección \ref{sec:csat}).
