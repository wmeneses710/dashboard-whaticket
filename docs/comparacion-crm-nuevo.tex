...
Horario de atención \emph{por departamento} & \si & \no \\
...
\subsubsection*{2. No se puede focalizar: la reciben todos}
...
jugadores. AGENTES VIP recibió 160 y no respondió ninguna. No existe forma de dirigir la
encuesta a un grupo de contactos: se envía a todos por igual, incluidos agentes,
jugadores VIP y jugadores nuevos.
...
\begin{enumerate}
  \item \textbf{Poder dirigirla a un grupo de contactos.} Hoy se envía a todos; el
        81,7\,\% termina en agentes, que no son el público de la medición.
